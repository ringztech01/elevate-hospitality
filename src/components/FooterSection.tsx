    ...
    <section style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          A three-person team that takes hospitality projects from the first idea to the last table turned. Architecture, engineering, and 16 years of operations, all under one roof.
        </p>
